...
@section('content')
    ...
    <div class="section-spacing">
        <div class="container">
            ...
            <div class="row">
                @php $products = [['title' => 'Oversized Tee', 'price' => 'Rp 299.000', 'badge' => 'New Arrival'], ['title' => 'Minimalist Hoodie', 'price' => 'Rp 499.000', 'badge' => 'Best Seller'], ['title' => 'Slim Fit Pants', 'price' => 'Rp 399.000', 'badge' => 'Limited'], ['title' => 'Monochrome Cap', 'price' => 'Rp 149.000', 'badge' => 'Last Stock']]; @endphp
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-1" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                    <div class="about-content">
                        ...
                        <p>Veravia hadir untuk wanita modern yang mengutamakan kenyamanan tanpa mengorbankan gaya. Setiap
                            koleksi kami dirancang dengan cermat untuk memperkuat rasa percaya diri, tampil berkelas, dan
                            tetap minimalis dalam setiap kesempatan.</p>
                        <p>Kami percaya bahwa pakaian berkualitas adalah investasi untuk tampil elegan di setiap momen
                            penting dalam hidup.</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Pastikan light mode dengan menghapus class dark-mode jika ada
