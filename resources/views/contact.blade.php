...
@section('content')
            ...
            <div class="container">
                ...
                <div class="row mt-3">
                    <div class="col-lg-7">
                        ...
                        <form class="form-container" id="contactForm" method="POST" action="{{ route('contact.send') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <textarea class="form-control form-textarea" id="message" name="message" rows="2" placeholder=" " required></textarea>
    ...
    <script>
        ...
        // ===== 🚨 AUTO OPEN POPUP AFTER FORM SUBMIT =====
