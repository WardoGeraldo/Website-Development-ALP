...
<style>
    ...
    .product-card {
        ...
        width: 230px; /* Fixed width for consistent card size */
        max-width: 100%;
    }
...
<div class="store-wrapper">
    ...
    <div class="product-grid" id="productGrid">
        @foreach($products as $product)
            <div class="product-card" data-category="{{ $product['category'] }}" data-aos="fade-up" data-aos-duration="800" data-aos-delay="{{ $loop->index * 100 }}" data-aos-once="false">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price-cart">
                        ...
                        <button class="btn-cart" onclick="addToCart('{{ $product['id'] }}', '{{ $product['name'] }}')">Add to Cart</button>
                    </div>
                </div>
            </div>
        @endforeach
