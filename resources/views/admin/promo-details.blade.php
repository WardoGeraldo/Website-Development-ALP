...
<div class="container">
    ...
    <form action="{{ route('admin.promo.update', ['id' => $promo['promo_id']]) }}" method="POST" class="promo-form" data-aos="fade-up" id="promoForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="promo_code" class="form-control with-icon" 
                                   value="{{ old('promo_code', $promo['promo_code'] ?? $promo['code']) }}" 
                                   required maxlength="20" placeholder="Enter promo code...">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" name="discount" class="form-control with-icon" 
                                   value="{{ old('discount', (float) $promo->discount_amount) }}" 
                                   required min="1" max="100" placeholder="e.g. 20">
        ...
        <div class="btn-container" data-aos="zoom-in" data-aos-delay="600">
            ...
            <a href="{{ route('admin.promo.list') }}" class="btn btn-back">
                <span class="btn-content">
