...
<div class="container">
    ...
    <form action="{{ route('admin.user.update', ['id' => $user['id']]) }}" method="POST" class="user-details" data-aos="fade-up" id="editUserForm">
        @csrf
        ...
        <div class="form-section" data-aos="fade-right" data-aos-delay="200">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="name" class="form-control with-icon" value="{{ $user['name'] }}" placeholder="Enter full name..." required>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="email" name="email" class="form-control with-icon" value="{{ $user['email'] }}" placeholder="Enter email address...">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="phone" class="form-control with-icon" value="{{ $user['phone'] }}" placeholder="Enter phone number...">
        ...
        <div class="form-section" data-aos="fade-left" data-aos-delay="400">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="address" class="form-control with-icon" value="{{ $user['address'] }}" placeholder="Enter address...">
