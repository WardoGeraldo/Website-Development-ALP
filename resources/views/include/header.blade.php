    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            ...
            <form class="d-flex mx-auto w-50" onsubmit="filterProductsBySearch(event)">
                <input id="searchInput" class="form-control rounded-pill ps-3" type="search" placeholder="Cari produk, tren, dan merek." aria-label="Search">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                @if(session('user')) <!-- Cek apakah ada user yang login -->
